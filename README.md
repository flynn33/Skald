...
JSON is emitted as a readable document model (version `1.1` for existing non-delimited formats; version `1.2` for CSV/TSV import-settings metadata) with:
