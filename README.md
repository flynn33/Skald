...
JSON is emitted as a readable document model (version `1.1` for existing non-delimited formats; version `2.0` for canonical CSV/TSV tables and import settings) with:
